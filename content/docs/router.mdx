...
```tsx
import { RouterProvider, NavigationContainer } from "@/components/core/router";
...
```tsx
import { Ornament } from "@/components/core/router";
...
```tsx
import { Stack } from "@/components/core/router";
...
```tsx
import { useRouter } from "@/components/core/router";
